...
- [OpenViking](https://github.com/volcengine/OpenViking) - Context Database for agents: virtual filesystem with L0/L1/L2 tiered loading, directory-recursive retrieval, VLM multimodal ingestion, session memory. Heavy infra but solves token budget for large corpora. See [docs/openviking-comparison.md](../docs/openviking-comparison.md) for integration potential (no use of it currently).
